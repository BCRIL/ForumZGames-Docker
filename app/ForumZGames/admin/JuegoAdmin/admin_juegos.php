...
<body>
    ...
    <div class="no-sidebar">
        ...
        <a href="anyadir_juego.php" class="anyadir-button">
            <i class='bx bx-plus'></i> Añadir juego
        </a>
            ...
            <?php if ($juego_destacado): ?>
                ...
                <div id="loginModal" class="modal">
                    <div class="modal-content">
                        ...
                        <p>Necesitas iniciar sesión con una cuenta de usuario o registrarte para votar.</p>
                        <div class="button-container">
                            <button class="modal-button" onclick="window.location.href='../.././login/login.php'">Iniciar Sesión</button>
